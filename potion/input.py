...
class Input:
    ...
    def init_default(cls) -> None:
        ...
        cls.add_button("Down")
        cls.map_key_to_button(sdl2.SDLK_DOWN, "Down")
        ...
        cls.add_button("Left")
        cls.map_key_to_button(sdl2.SDLK_LEFT, "Left")
        ...
        cls.map_key_to_button(sdl2.SDLK_RIGHT, "Right")
        ...
        cls.map_key_to_button(sdl2.SDLK_ESCAPE, "Start")
